...
source: https://github.com/YOUR-ORG/linked-knowledge-format/blob/main/bundle/.lkf-reference.md
...
This bundle is a flat directory of markdown files. Domain files represent
concepts such as SOPs, policies, metrics, source documents, research
notes, terms, decisions, application components, or ideas. Control files
describe how to operate the bundle and are not domain concepts. Concept
files link to each other to express relationships. The directory has no
subfolders. All organization is carried by links and index files.
...
Control files describe how this bundle works. They are not domain concepts
and do not need to appear in group indexes:

- `AGENTS.md` - agent operating guide
- `.lkf-reference.md` - this navigation and structure guide
- `.lkf-maintenance.md` - maintenance conventions for this bundle
...
This file is a built-in control file that ships in every LKF bundle.
It describes how to work with the bundle it lives in, not an external
standard. Control files are exempt from the no-orphan rule and do not need
to be listed in any group index.

The canonical version of this file is maintained at:
https://github.com/YOUR-ORG/linked-knowledge-format/blob/main/bundle/.lkf-reference.md
